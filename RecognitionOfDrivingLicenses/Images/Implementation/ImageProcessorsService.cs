...
namespace Bsuir.Misoi.Core.Images.Implementation
{
    public class ImageProcessorsService : IImageProcessorsService
    {
        ...
        private IEnumerable<IImageProcessor> RegiterProcessors()
        {
            ...
            //yield return new SelectFounedAreaAfterSegmentationImageProcessor(_findResultDrawer, _segmentationAlogithm, new CarNumberSegmentFindAnalyzer(), new LaplacianFiveFilter(_convolutionFilter));
            yield return new SelectFounedAreaAfterSegmentationImageProcessor(new FindResultCliper(), _segmentationAlogithm, new CarNumberSegmentFindAnalyzer("Clip document"), new LaplacianFiveFilter(_convolutionFilter));
        }
    }
}
